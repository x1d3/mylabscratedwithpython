...
if __name__ == "__main__":
    main()
"""
Добавьте в вашу программу для 3 задания 7 лабораторной работы 
воз-можность сохранять данные в файл и загружать данные из файла с помощью соответствующих пунктов меню. 

7.3
1.	Описать словарь price, где в качестве ключей используются кортежи вида (наименование магазина,
 наименование товара), а в качестве значений сло-вари со следующими данными: 
 наименование магазина, наименование това-ра, количество товара на складе, стоимость товара.
2.	Написать программу, выполняющую следующие действия:
•	ввод данных с сохранением в словаре;
•	поиск информации о магазинах, в которых есть товар, название 
которого ведено с клавиатуры, со стоимостью, не превышающей значение, введен-ное с клавиатуры.
