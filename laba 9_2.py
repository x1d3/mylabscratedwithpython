...
"""
Реализуйте сортировку матрицы по следующим условиям соответственно варианту,
 как используя функции и методы, представленные в 9.8. (можно ис-пользовать numpy), так и не используя:
1.	Сортировка всех элементов слева-направо сверху-вниз в порядке возрас-тания.
