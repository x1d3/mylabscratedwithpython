...
if __name__ == "__main__":
    main()
    """
15.	Дана матрица размера m*n, элементами которой являются “#” и “.”.
 Вме-сто “.” может поставлено любое число от 0 до n, где n-количество сосед-них “#” 
 по вертикали и горизонтали возле данной “.”. Найдите количе-ство матриц, которое можно 
 составить в итоге. 
    """