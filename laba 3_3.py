...
заданной в виде графика. Параметры, необ-ходимые для решения задания следует получить из 
графика и определить в программе. График функции выбрать согласно варианту.
"""